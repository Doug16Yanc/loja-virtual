...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, lojavirtual.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, lojavirtual.repository.UserRepository.USERS_BY_EMAIL_CACHE);
