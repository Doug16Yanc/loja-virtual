...
/**
 * REST controller for managing {@link lojavirtual.domain.ItemPedido}.
 */
@RestController
...
public class ItemPedidoResource {
        ...
        Optional<ItemPedido> result = itemPedidoRepository
            ...
            .map(existingItemPedido -> {
                ...
                if (itemPedido.getPrecoUnitario() != null) {
                    existingItemPedido.setPrecoUnitario(itemPedido.getPrecoUnitario());
                }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ItemPedido>> getAllItemPedidos(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of ItemPedidos");
        Page<ItemPedido> page = itemPedidoRepository.findAll(pageable);
